...
String htmlPage() {
  ...
  s += "ws.onmessage=e=>{let d=JSON.parse(e.data);ssid.textContent=d.ssid;ip.textContent=d.ip;apSsid.value=d.ssid;sw1Name.value=d.n1;sw2Name.value=d.n2;mdnsName.value=d.mdns;timerSec.value=d.d;theme.value=d.theme;upd(1,d.r1,d.n1);upd(2,d.r2,d.n2);c1.textContent=d.t1;c2.textContent=d.t2;};";
